...
public class RCC_Editor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("overrideBehavior"), new GUIContent("Override Behavior", "Vehicle won't be affected by selected behavior in RCC Settings if enabled."), false);
        EditorGUILayout.Space();
        ...
        if (GUI.changed && !EditorApplication.isPlaying) {
            ...
            if (RCC_Settings.Instance.setLayers)
                SetLayers();
    ...
    private void ConfigurationTab() {
        ...
        EditorGUILayout.Space();
        EditorGUILayout.PropertyField(serializedObject.FindProperty("configureVehicleSubsteps"), new GUIContent("Configure Vehicle Substeps", "Configures vehicle substeps."), false);
    ...
    private void LightingTab() {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("lowBeamHeadLightsOn"), new GUIContent("Head Lights On", "Headlights are on now?"));
        EditorGUILayout.Space();
