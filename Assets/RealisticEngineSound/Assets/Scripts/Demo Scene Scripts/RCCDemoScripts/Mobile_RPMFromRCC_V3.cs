...
public class Mobile_RPMFromRCC_V3 : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        res_mob.carMaxSpeed = rccV3.maxspeed; // needed for straight cut gearbox script
    }
    void Update()
    {
        if (rccV3 != null)
        {
            ...
            res_mob.carCurrentSpeed = rccV3.speed; // needed for straight cut gearbox script
            res_mob.isShifting = rccV3.changingGear; // needed for shifting sounds script
            ...
            // gas pedal
            if (rccV3.throttleInput >= 0.1f) // gas pedal is pressing
            {
            ...
            if (rccV3.throttleInput < 0.1f && rccV3.throttleInput > -0.1f) // gas pedal is not pressing
            {
                res_mob.gasPedalPressing = false;
            }
        }
